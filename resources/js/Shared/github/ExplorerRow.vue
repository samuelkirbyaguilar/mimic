<template>
    <div class="flex justify-between px-4 py-2 hover:bg-gray-100">
        <div class="w-8/12 lg:w-4/12 flex items-center">
            <svg
                v-if="isFolder"
        ...
        <div
            class="w-6/12 hidden lg:block
            truncate text-gray-500">
            <a href="#" class="hover:underline hover:text-blue-600 ml-3">{{ commitMessage }}</a>
        </div>
        <div class="w-4/12 lg:w-2/12 text-right text-gray-500">
